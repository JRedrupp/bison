...
def test_df_isna_no_nulls() raises:
    ...
    var col_a = result["a"]
    for i in range(3):
        assert_true(not col_a._col._bool_list()[i])
...
def test_df_isna_with_nulls() raises:
    ...
    var result = df.isna()
    var col_a = result["a"]
    assert_true(not col_a._col._bool_list()[0])
    assert_true(col_a._col._bool_list()[1])
    assert_true(not col_a._col._bool_list()[2])
...
def test_df_isnull_alias() raises:
    ...
    var c2 = r2["x"]
    for i in range(2):
        assert_equal(c1._col._bool_list()[i], c2._col._bool_list()[i])
...
def test_df_notna_with_nulls() raises:
    ...
    var result = df.notna()
    var col_a = result["a"]
    assert_true(col_a._col._bool_list()[0])
    assert_true(not col_a._col._bool_list()[1])
    assert_true(col_a._col._bool_list()[2])
...
def test_df_fillna_float() raises:
    ...
    assert_equal(result.shape()[0], 3)
    var col_a = result["a"]
    assert_equal(col_a._col._float64_list()[1], Float64(0.0))
...
def test_df_ffill() raises:
    ...
    var result = df.ffill()
    var col_a = result["a"]
    assert_equal(col_a._col._float64_list()[1], Float64(1.0))
    assert_equal(col_a._col._float64_list()[2], Float64(1.0))
    assert_equal(col_a._col._float64_list()[3], Float64(4.0))
...
def test_df_bfill() raises:
    ...
    var result = df.bfill()
    var col_a = result["a"]
    assert_equal(col_a._col._float64_list()[0], Float64(3.0))
    assert_equal(col_a._col._float64_list()[1], Float64(3.0))
...
def test_df_interpolate_linear() raises:
    ...
    var col_a = result["a"]
    assert_equal(col_a._col._float64_list()[1], Float64(2.0))
